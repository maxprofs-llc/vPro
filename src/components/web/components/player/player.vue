...
<script>
  ...
  export default {
    mounted() {
      ...
      if (Object.keys(this.$route.query).length !==0 && this.$route.query.course_id !==undefined && this.$route.query.lesson_id !== undefined) {}
      this.player.playlist(this.source)
      console.log(this.player.playlist.currentItem(10))
